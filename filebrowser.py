...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("FileManager")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtWidgets.QApplication.translate("FileManager", "FileManager", None, -1))
...
class MyFileBrowser(Ui_MainWindow, QtWidgets.QMainWindow):
    ...
    def context_menu(self):
        ...
        open = menu.addAction("Copy")
        open.triggered.connect(self.copy_file)
